 ...
 *
 * @param orderedChapterIds List of chapter UUIDs in the desired display order (index 0 = first)
 */
public record ReorderChaptersRequest(
        @NotEmpty(message = "Chapter order list cannot be empty")
        List<@NotNull UUID> orderedChapterIds
) {}
